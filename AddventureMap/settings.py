"""
Django settings for AddventureMap project.
...
SECRET_KEY = 'django-insecure-q_v!c6=(wwyt%e(=i8p%=5j+8^$v_$np!o*+uwxj!0441hvpq*'
...
ROOT_URLCONF = 'AddventureMap.urls'
...
WSGI_APPLICATION = 'AddventureMap.wsgi.application'
